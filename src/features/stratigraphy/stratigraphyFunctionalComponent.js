...
const Stratigraphy = (props) => {
  ...
  const updateDimensions = () => {
    // console.log("updateDimensions", element);
          ...
          <div
            ...
            style={{
              ...
              ...{
                ...
                //  * 200 by Mali
                height:
                  (layer[mapping.to] - layer[mapping.from]) * pxm * 200 + "px",
                position: "relative",
                margin: "0px 12px",
              },
            }}
            ...
            return (
              <div
                ...
                style={{
                  ...
                  // state.selected is null and crashed
                  // ...(state?.selected !== null &&
                  // state?.selected.id === layer[mapping.id]
